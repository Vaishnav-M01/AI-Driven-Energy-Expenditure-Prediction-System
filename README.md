...
| AI-Driven Energy Expenditure Prediction System.ipynb | Notebook for preprocessing, feature engineering, and model training |
| final_model.joblib | Trained Random Forest model pipeline |

---

# ⚠ *Note on Large Files:*  
- The trained model file (final_model.joblib) is *not included* due to GitHub’s file size limits.  
